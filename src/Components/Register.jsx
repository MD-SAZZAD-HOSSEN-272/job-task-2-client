...
const Register = () => {
    ...
    const {
      ...
      const onSubmit = (data) => {
        const {confirm_password, password, email, ...rest} = data;
        ...
        <div className="bg-[#0b1c0b] text-white rounded-2xl shadow-xl overflow-hidden w-full max-w-4xl grid md:grid-cols-2">
          ...
          <div className="p-8 flex flex-col justify-center">
            ...
            <p className="text-sm text-gray-400 mb-6">
              ...
              <Link to='/auth' className="text-green-500">Sign in</Link>
            </p>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div >
                <div className="relative">
                  ...
                  className="w-full px-4 py-3 rounded-md bg-transparent border border-gray-600 focus:border-green-500 outline-none"
                />
                <span onClick={() => setShowPassword(!showPassword)}>{showPassword ? <FaRegEyeSlash className="absolute right-5 top-1/2 -translate-y-1/2" /> : <FaEye className="absolute right-5 top-1/2 -translate-y-1/2" ></FaEye>}</span>
                </div>
                {errors.password && (
                  <p className="text-red-500 text-sm mt-1">
